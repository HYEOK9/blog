...
function Dock() {
  ...
  return (
    <div className="flex h-full relative items-center justify-between px-1 pt-1 pb-2 rounded-2xl bg-gray-400 dark:bg-navy-400 border border-slate-600 z-dock backdrop-blur-sm transition-all">
