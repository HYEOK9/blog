...
export const IFRAME_VSCODE_URL = (theme: "dark" | "light") =>
  `https://stackblitz.com/github/HYEOK9/blog?embed=1&file=src/component/Home.tsx&hideNavigation=1&theme=${theme}&view=editor` as const;
export const GOOGLE_URL = "https://google.com" as const;
